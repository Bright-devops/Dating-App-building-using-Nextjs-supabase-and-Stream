...
export default function EditProfilePage() {
  ...
  if (loading) {
    return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-red-50 dark:from-gray-900 dark:to-gray-800 pb-12">
      <div className="container mx-auto px-4 py-8 min-h-screen"></div>
  ...
  return (
   <div className="min-h-screen bg-gradient-to-br from-pink-50 to-red-50 dark:from-gray-900 dark:to-gray-800 flex flex-col">
