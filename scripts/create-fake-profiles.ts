...
// Configuration
const SUPABASE_URL = `https://jmhccdjhxhkwomiiefhp.supabase.co`;
const SUPABASE_SERVICE_ROLE_KEY = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImptaGNjZGpoeGhrd29taWllZmhwIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MTc5Nzk1OSwiZXhwIjoyMDc3MzczOTU5fQ.6WdG1UlKuR9s37KdWGs8DRTFFHafYCt1_2q8b64RcDA`;
const PASSWORD = "Lovestory@2025!";
